...
import type { AwardFormState } from "@/app/admin/(protected)/awards/actions";
  ...
  return (
    <form action={formAction} className="space-y-8">
      ...
      <section className="rounded-lg border border-sand-deep bg-white p-6">
        <TextArea label="Description" name="description" defaultValue={values.description} error={state.fieldErrors?.description} rows={3} />
      </section>
