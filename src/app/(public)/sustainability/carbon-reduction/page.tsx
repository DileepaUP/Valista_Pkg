...
import { carbonReductionPoints } from "@/data/sustainability-content";
import { getMetricsByCategory } from "@/data/environmental-metrics";

export const metadata: Metadata = {
  title: "Carbon Reduction — Valista Packaging",
};

export default function CarbonReductionPage() {
  const metrics = getMetricsByCategory("Carbon Reduction");

  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-16">
      <h1 className="font-display text-3xl font-semibold text-charcoal">Carbon Reduction</h1>
      <ul className="mt-8 space-y-4">
        {carbonReductionPoints.map((point) => (
